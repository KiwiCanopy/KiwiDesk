...
(#1403), `spaces-and-desktops.md` (#1398); every other page is
swept by its own audit under collector #1406, and `docs/recipes/`
joins when its audit is filed. Extend the swept list here in the
same change set as the sweep.
...
never articles or verbs, and the result is ordinary prose. The one
