...
| **Track** | array-order | steps both axes (`trackStep`) | yes — an overflow cascade (`OverlapStack.overflowFrames`); within-track pile shaped by `overflow_style` (#188, default `cascade_all`), cross-axis stays `cascade_overflow` |
