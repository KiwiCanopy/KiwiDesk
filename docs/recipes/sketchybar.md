...
| `native_space_change` | `native_space`, `monitor` | A macOS Desktop switches on some screen (`monitor` 1 is the main display) |
...
-- their own switches too — filter on the main display so the
