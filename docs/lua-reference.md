...
window an already-running app opens, the windows macOS reopens
at login or KiwiDesk finds when it starts, and the windows a
Desktop switch shows you stay in their space
