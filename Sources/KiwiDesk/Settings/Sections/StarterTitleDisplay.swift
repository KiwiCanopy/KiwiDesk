...
extension StarterTitle {
    ...
    /// key per class, since the noun inflects in some locales; a
    /// setup across several screens names none of them (#1662).
    @MainActor var onboardingTitle: String {
        guard otherScreens == 0 else {
            return L(
                "onboarding.starter_spaces.title.several_screens",
