...
public enum APIReference {
    ...
    public static let namespaces: [String: [String]] = [
        ...
        "space_bar": [
            "set_enabled", "set_glyph_cap",
            "set_icon_source", "set_active_indicator", "set_dim_factor",
            "set_active_dim_factor",
            "set_show_front_app", "set_front_app_title_cap", "set_hide_empty",
            "set_sticky_badge",
            "set_spring_delay",
        ...
        "kiwishelf": [
            "set_edge", "set_alignment", "set_order", "set_share",
