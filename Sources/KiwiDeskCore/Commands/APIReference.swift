...
public enum APIReference {
    ...
    public static let namespaces: [String: [String]] = [
        ...
        "monocle": [
            "set_orientation",
            "set_bar_enabled", "set_bar_position",
            "set_bar_thickness", "set_bar_style",
            "set_bar_active_style", "set_bar_item_size",
            "set_bar_item_gap",
            "set_bar_content", "set_bar_font_size",
            "set_bar_corner_radius",
            "set_bar_text_color", "set_bar_box_color",
