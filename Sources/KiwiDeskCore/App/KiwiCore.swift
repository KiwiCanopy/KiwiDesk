...
public final class KiwiCore {
    ...
    /// the #465 sibling distrust ranks by it; the placement
    /// bounce takes a second, longer reading (#1161). Minted ONLY
    /// through `stampSelfRaise`, which prunes to the longer
    /// window; NEVER consumed by an echo (#887, like
