...
/// not list it. Two instances drain on the one `.windowCreated`
/// arm: `KiwiCore.followFocus` (`move_to_desktop_and_follow`,
/// #1007) and `DesktopMemory.returnFocus` (a Desktop return,
/// #1207) — same drain key, the arriving window; same
/// cardinality, one pending. The follow outranks the return. A
