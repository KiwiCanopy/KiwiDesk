...
public struct StickyStyle: Sendable, Equatable {
    ...
    /// Whether sticky windows follow the user across macOS
    /// Desktops (#1145) — carried onto the arriving Desktop of
    /// their screen at each switch. Inert without the bridge
    /// (`canDriveDesktops`); the `override_sticky_reach`
