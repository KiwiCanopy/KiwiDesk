...
/// seal's disabled fill against the two live ones,
/// `BorderRingSeparationTests` for the focused ring against
/// the composited unfocused one — and a hand-copied transform
/// that
