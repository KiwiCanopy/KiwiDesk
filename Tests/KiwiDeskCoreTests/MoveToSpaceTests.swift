...
/// The animation-gating tests (#11) and the desktop-yield
/// tests (#446) live in the sibling
/// `MoveToSpaceAnimationGateTests.swift` and
/// `MoveToSpaceDesktopYieldTests.swift` files.
