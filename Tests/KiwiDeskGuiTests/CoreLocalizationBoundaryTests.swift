...
struct CoreLocalizationBoundaryTests {
    ...
    private let allowed: [String: Int] = [
        ...
        // The resize refusal pills (#933, #1055) are the same
        // shape: a `KiwiCore` extension authoring the
        // own-minimum, neighbor-minimum and own-maximum
        // sentences it hands to the Core-drawn
        // `SizeLimitOverlay`. Same caveat as `+StickyMarks` if
        // the overlays ever move out of Core.
        "App/KiwiCore+SizeLimitPill.swift": 4,
